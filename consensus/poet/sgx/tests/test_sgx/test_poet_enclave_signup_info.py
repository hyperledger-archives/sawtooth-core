...
class TestPoetEnclaveSignupInfo(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_verify_serialized_signup_info(self):
        ...
        self.assertEqual(signup_info.poet_public_key, signup_info_doppleganger.poet_public_key)
        self.assertNotEqual(signup_info.sealed_signup_data, signup_info_doppleganger.sealed_signup_data)
        self.assertEqual(signup_info.proof_data, signup_info_doppleganger.proof_data)
        self.assertEqual(signup_info.anti_sybil_id, signup_info_doppleganger.anti_sybil_id)
