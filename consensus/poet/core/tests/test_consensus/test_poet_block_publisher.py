...
class TestPoetBlockPublisher(TestCase):
    ...
    @patch('sawtooth_poet.poet_consensus.wait_timer.WaitTimer')
    @mock.patch('sawtooth_poet.poet_consensus.poet_block_publisher.'
                'SignupInfo')
    @mock.patch('sawtooth_poet.poet_consensus.poet_block_publisher.'
                'PoetKeyStateStore')
    ...
    def test_block_publisher_claim_readiness(
        ...
        mock_wait_time = mock.Mock()
        mock_wait_time.has_expired.return_value = True

        mock_wait_time.create_wait_timer.return_value = mock_wait_time
        ...
        # create a mock_wait_certificate with a non valid wait timer
        mock_wait_certificate = mock.Mock()
        mock_wait_certificate.create_wait_certificate.return_value = \
            mock.Mock(poet_enclave_module=mock_poet_enclave_module,
                      wait_timer=mock_wait_time,
    ...
    def test_block_publisher_doesnt_claim_readiness(
        ...
        mock_wait_time = mock.Mock()
        mock_wait_time.has_expired.return_value = False
