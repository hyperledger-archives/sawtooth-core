...
from sawtooth_private_utxo.processor.handler import PrivateUtxoHandler
...
def main(args=None):
    ...
    try:
        ...
        log_config = get_log_config(filename="private_utxo_log_config.toml")
        if log_config is not None:
            ...
            log_configuration(
                log_dir=log_dir,
                name="private-utxo-" + str(processor.zmq_id)[2:-1])

        processor.add_handler(PrivateUtxoHandler())
