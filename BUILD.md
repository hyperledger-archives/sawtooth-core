...
[Docker DNS(Optional)](#Docker-DNS-(Optional)) section below.
...
## Build and Start a Validator Node
...
from the source in your workspace. You can inspect `docker-compose.yaml`
to see how the various components are launched and connected.
