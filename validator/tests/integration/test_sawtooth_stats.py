...
class SawtoothStatsTest(StatsModule):
    ...
    def test_stats_values(self, expected_params):
        ...
        assert self.stats["summary_stats"]["topology"]["maximum_shortest_path_length"] >=\
        ...
        assert self.stats['summary_stats']["blocks"]["blocks_max_committed"] > \
        ...
        assert self.stats["summary_stats"]["packets"]["packets_max_acks_received"] > \
