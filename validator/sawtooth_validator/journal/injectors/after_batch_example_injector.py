...
class AfterBatchExampleInjector(BatchInjector):
    """Inject intkey transactions before each batch."""
    ...
    def after_batch(self, previous_block, batch):
        """Returns an ordered list of batches to inject after the current
