...
class IntegerKeyClient(SawtoothClient):
    def __init__(self,
        ...
        super(IntegerKeyClient, self).__init__(
            ...
            txntype_name=integer_key.IntegerKeyTransaction,
            msgtype_name=integer_key.IntegerKeyTransaction.MessageType,
            keystring=keystring,
            keyfile=keyfile,
    ...
    def _sendtxn(self, update, txndep=None, postmsg=True):
        ...
        return self.sendtxn(
            txntype_name=integer_key.IntegerKeyTransaction.
            TransactionTypeName,
            msgtype_name=integer_key.IntegerKeyTransaction.
