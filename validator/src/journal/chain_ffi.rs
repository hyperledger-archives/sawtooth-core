...
pub unsafe extern "C" fn chain_controller_new(
    ...
    consensus_notifier_service: *mut py_ffi::PyObject,
    ...
    let py_notifier_service = PyObject::from_borrowed_ptr(py, consensus_notifier_service);
    ...
    let chain_controller = ChainController::new(
        ...
        results_cache,
        Box::new(PyNotifierService::new(py_notifier_service)),
        data_dir.into(),
...
pub unsafe extern "C" fn chain_controller_forks(
    ...
    match (*(chain_controller as *mut ChainController<PyExecutor, PyPermissionVerifier>))
        .forks(head)
    {
