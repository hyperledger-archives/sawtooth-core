...
SET SAWTOOTHVALIDATORHOME=%SAWTOOTHOME%validator\
SET MKTPLACEHOME=%SAWTOOTHOME%extensions\mktplace\

SET POETHOME=%STHOME%sawtooth-poet\

SET CURRENCYHOME=%SAWTOOTHVALIDATORHOME%
SET CURRENCYBIN=%CURRENCYHOME%bin\
SET CURRENCYLIBS=%SAWTOOTHCOREHOME%;%SAWTOOTHCOREHOME%\build\lib.win-amd64-2.7;%MKTPLACEHOME%;%SAWTOOTHVALIDATORHOME%;%POETHOME%
SET PYTHONPATH=%CURRENCYLIBS%

SET PATH=%PATH%;%SCRIPTDIR%;%SAWTOOTHVALIDATORHOME%bin;%MKTPLACEHOME%bin
