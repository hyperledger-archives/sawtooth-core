...
SET CURRENCYLIBS=%SAWTOOTHHOME%;%SAWTOOTHHOME%\build\lib.win-amd64-2.7;%MKTPLACEHOME%;%SAWTOOTHVALIDATORHOME%;%POETHOME%
...
SET ST_VE=%MLHOME%sawtooth-virtual-env-win\
