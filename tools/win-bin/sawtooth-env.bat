...
SET CURRENCYLIBS=%SAWTOOTHCOREHOME%;%SAWTOOTHVALIDATORHOME%\build\lib.win-amd64-2.7;%SAWTOOTHVALIDATORHOME%;%POETHOME%
SET PYTHONPATH=%CURRENCYLIBS%

SET PATH=%PATH%;%SCRIPTDIR%;%SAWTOOTHHOME%bin
