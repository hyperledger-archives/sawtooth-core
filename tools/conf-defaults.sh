...
[[ -z "$PLUGINS" ]] && export PLUGINS="setup_homedir build_ubuntu_deps install_ubuntu_deps install_sphinx install_grpc install_bitcoin install_aiohttp install_js_tools install_docker"
