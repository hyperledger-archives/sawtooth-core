...
[[ -z "$PLUGINS" ]] && export PLUGINS="setup_homedir build_ubuntu_deps install_ubuntu_deps install_sphinx install_lmdb install_grpc install_bitcoin install_zmq install_aiohttp"
