...
#. Use the following ``docker`` command to list all running Docker containers
   ...
   .. code-block:: console
      ...
      93d048c01d30 hyperledger/sawtooth-rest-api:nightly         "sawtooth-rest-api -" 7 minutes ago Up 7 minutes 4004/tcp, 0.0.0.0:8008->8008/tcp sawtooth-rest-api-default
      6bbcda66a5aa hyperledger/sawtooth-validator:nightly        "bash -c 'sawadm key" 7 minutes ago Up 7 minutes 0.0.0.0:4004->4004/tcp           sawtooth-validator-default
