...
This tutorial covers the creation of a new Sawtooth Lake transaction handler
...
A full implementation of the tic-tac-toe transaction processor can be found in
